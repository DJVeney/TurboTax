...
INSERT INTO usuario (id, estado, fecharegitro, fechaultimamodificacion, nombre, password, username) VALUES (2, 'ACTIVO', NULL, NULL, 'Invitado', '8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92', 'guest');
...
INSERT INTO grupo (id, estado, fecharegitro, fechaultimamodificacion, nombre, empresa_id) VALUES (2, 'ACTIVO', NULL, NULL, 'facilerp', 1);
...
SELECT pg_catalog.setval('grupo_id_seq', 2, true);
...
INSERT INTO submenu (id, estado, fecharegitro, fechaultimamodificacion, icon, label, modulo_id, usuarioultimamodificacion) VALUES (7, 'ACTIVO', '2016-03-18 17:35:15', NULL, 'icon-uniE675', 'Seguridad', 1, NULL);
INSERT INTO submenu (id, estado, fecharegitro, fechaultimamodificacion, icon, label, modulo_id, usuarioultimamodificacion) VALUES (8, 'ACTIVO', '2016-03-18 17:35:15', NULL, 'icon-uniE675', 'Configuraciones', 5, NULL);
...
INSERT INTO menuitem (id, estado, fecharegitro, fechaultimamodificacion, icon, url, valor, submenu_id, usuarioultimamodificacion) VALUES (22, 'ACTIVO', NULL, NULL, 'icon-uniE675', '/main/configuracion/rol/listado.xhtml', 'Roles', 7, NULL);
INSERT INTO menuitem (id, estado, fecharegitro, fechaultimamodificacion, icon, url, valor, submenu_id, usuarioultimamodificacion) VALUES (23, 'ACTIVO', NULL, NULL, 'icon-uniE675', '/main/configuracion/usuario/listado.xhtml', 'Usuarios', 7, NULL);

INSERT INTO menuitem (id, estado, fecharegitro, fechaultimamodificacion, icon, url, valor, submenu_id, usuarioultimamodificacion) VALUES (24, 'ACTIVO', NULL, NULL, 'icon-uniE675', '/main/stock/marca/listado.xhtml', 'Marcas', 8, NULL);
INSERT INTO menuitem (id, estado, fecharegitro, fechaultimamodificacion, icon, url, valor, submenu_id, usuarioultimamodificacion) VALUES (25, 'ACTIVO', NULL, NULL, 'icon-uniE675', '/main/stock/procedencia/listado.xhtml', 'Procedencias', 8, NULL);
...
SELECT pg_catalog.setval('menuitem_id_seq', 26, true);
...
SELECT pg_catalog.setval('submenu_id_seq', 9, true);
...
INSERT INTO usuario_empresa (empresas_id, usuarios_id) VALUES (1, 1);
INSERT INTO usuario_empresa (empresas_id, usuarios_id) VALUES (1, 2);
