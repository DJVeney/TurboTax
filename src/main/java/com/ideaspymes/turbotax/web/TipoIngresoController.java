...
import com.ideaspymes.turbotax.utils.JsfUtil.PersistAction;
...
public class TipoIngresoController implements Serializable {
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("TipoIngresoCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("TipoIngresoUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("TipoIngresoDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public TipoIngreso getTipoIngreso(java.lang.Long id) {
